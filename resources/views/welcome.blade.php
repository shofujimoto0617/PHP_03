            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="sm:justify-start sm:pt-0">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                        <h1>welcome to <strong>Bookers</strong> !!</h1>
                    <!-- <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-gray-700 sm:h-20">
                        ...
                        <p>In <strong> Bookers</strong> ,</p>
                        <p>you can share and exchange your opinions , impressions , and emotions</p>
                        <p> about various books!</p>
                    </div> 
                    <div class="mt-5">
                        <p>
                            <a href="{{ route('login') }}" class="pr-5 pl-5 btn btn-info">Login</a>
                            <a href="{{ route('register') }}" class="pr-5 pl-5 ml-2 btn btn-success">Register</a>
                        </p>
                    </div>                   
                </div>
